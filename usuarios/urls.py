...
from .views import index, Logueo, register_step_1, register_step_2, olvidaste_contrasena, restablecer_contrasena, login_customer_user, logout_user, profile, update_perfil, update_perfil2
app_name = 'usuarios'
