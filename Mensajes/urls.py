...
from .views import sent_messages, farmer_messages, send_message, reply_message, reply_conversation, delete_sent_message, customer_reply_message, delete_sent_conversation, delete_farmer_conversation
...
urlpatterns = [
    ...
    path("recibidos-agricultor/eliminar-chat/", delete_farmer_conversation, name="delete_farmer_conversation"),
