"""
Django settings for agrophia project.
...
SECRET_KEY = 'django-insecure-!*w^nl+!g&8yj82(qmvvv8#*c$3_6+d6z*zspd%rb!=7v)w7o('
...
MIDDLEWARE = [
    ...
    'usuarios.middleware.RegisterFlowCleanupMiddleware',
